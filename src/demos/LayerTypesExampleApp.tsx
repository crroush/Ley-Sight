...
function buildFeatures(): Feature[] {
  ...
  const iconRows: readonly [
    number,
    number,
    string,
    string,
  ][] = [
    [37.8044, -122.2712, "path_object", "Icon from pathlib.Path with selected icon"],
  ...
  const remoteIcon = new Feature(
    new Point(fromLonLat([-122.3255, 37.563])),
  );
  ...
  const polygon = new Feature(new Polygon([[
