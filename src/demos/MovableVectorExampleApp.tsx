...
function createFeatures(): Feature[] {
  ...
  const features: Feature[] = [
    ...
    polygonFeature(
      [[41.5, -93], [40.5, -90], [39, -91.5], [39.8, -94]],
      "modify_polygon",
      "olive",
      "movable polygon",
      true,
    ...
    polygonFeature(
      [[34.5, -93], [33.5, -90], [32, -91.5], [32.8, -94]],
      "fixed_polygon",
      red,
      "not movable polygon",
      false,
  ...
  return (
    <main className="qt-example-window">
      <section className="qt-movable-instructions">
        ...
        <span>• Purple line and olive polygon: new vertices can be created.</span>
